// ============================================================
// pages/FoundItems.jsx — Fixed with proper filter reset
// ============================================================
...
const FoundItems = () => {
  ...
  const fetchAllItems = async () => {
    try {
      ...
      const items = response.data.foundItems;
      setAllItems(items);
  ...
  const handleClaim = async (id) => {
    ...
    try {
      ...
      // Update status in both arrays without re-fetching
      const updateStatus = (items) =>
        items.map((item) =>
          item._id === id ? { ...item, status: "claimed" } : item
        );
      setAllItems((prev) => updateStatus(prev));
      setFilteredItems((prev) => updateStatus(prev));
